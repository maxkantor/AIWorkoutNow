...
public class PricingController : ControllerBase
{
    ...
    public async Task<IActionResult> GetUserAccessStatus([FromQuery] string deviceId)
    {
        try
        {
            ...
            // AGGRESSIVE FIX: If no tokens on this device, but this visitor belongs to an email mapping,
            // merge credits from all linked devices into this one so home + CRM stay consistent.
